...
export const EditCampaignForm = ({ onSubmitSuccess }: CampaignFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newRow = {
      ...
      message: message,
      senderId: senderId,
      totalCustomers: 0, // Assuming this is needed, adjust as necessary
      createdDate: new Date().toLocaleDateString(), // Assuming you want to display the creation date
    };
  ...
  return (
    <>
      <h1 className="mb-0 text-center text-xl font-bold">Edit Campaign</h1>
